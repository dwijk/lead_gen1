# Generated by Django 4.2.18 on 2025-04-09 06:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_time_access_token', models.CharField(max_length=100, unique=True)),
                ('long_time_access_token', models.CharField(max_length=100, unique=True)),
